    ...
    try:
        ...
        updated_todo = {
            ...
            "description": body.get(
                "description", current_todo.get("description", {}).get("S", "")
            ),
            "completed": body.get(
                "completed", current_todo.get("completed", {}).get("BOOL", False)
            ),
            "priority": body.get(
                "priority", current_todo.get("priority", {}).get("S", "medium")
            ),
        ...
        return {
            ...
            "body": json.dumps(
                {"error": "Failed to update todo", "code": "INTERNAL_ERROR"}
            ),
        }
