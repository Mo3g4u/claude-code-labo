...
class TestAPIEndpoints:
    ...
    def test_health_check(self):
        ...
        try:
            response = requests.get(
                f"{self.base_url}/todos", params={"user_id": self.user_id}
            )
    ...
    def test_update_todo_not_found(self):
        ...
        update_data = {"user_id": self.user_id, "title": "This should not work"}
    ...
    def test_delete_todo_success(self):
        ...
        try:
            ...
            delete_response = requests.delete(
                f"{self.base_url}/todos/{todo_id}", params={"user_id": self.user_id}
            )
    ...
    def test_cors_headers(self):
        ...
        try:
            ...
            assert "GET, POST, PUT, DELETE" in response.headers.get(
    ...
    def test_api_workflow(self):
        ...
        try:
            ...
            response = requests.get(
                f"{self.base_url}/todos", params={"user_id": workflow_user}
            )
            assert response.status_code == 200
            ...
            # Step 5: 更新されたTodoを削除
            delete_response = requests.delete(
                f"{self.base_url}/todos/{todo_id}", params={"user_id": workflow_user}
            )
            assert delete_response.status_code == 204
