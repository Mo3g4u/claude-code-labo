...
from src.handlers.update_todo import lambda_handler, get_dynamodb_client
...
class TestUpdateTodo:
    ...
    def test_lambda_handler_todo_not_found(self):
        ...
        with patch('src.handlers.update_todo.get_dynamodb_client', return_value=mock_client):
            # When
            response = lambda_handler(event, context)
    ...
    def test_lambda_handler_success_partial_update(self):
        ...
        # DynamoDBクライアントをモック
        with patch('src.handlers.update_todo.get_dynamodb_client', return_value=dynamodb):
            # When
            response = lambda_handler(event, context)
