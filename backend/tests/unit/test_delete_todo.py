...
from src.handlers.delete_todo import lambda_handler, get_dynamodb_client
...
class TestDeleteTodo:
    ...
    def test_lambda_handler_todo_not_found(self):
        ...
        with patch('src.handlers.delete_todo.get_dynamodb_client', return_value=mock_client):
            # When
            response = lambda_handler(event, context)
    ...
    def test_lambda_handler_success_with_query_user_id(self):
        ...
        # DynamoDBクライアントをモック
        with patch('src.handlers.delete_todo.get_dynamodb_client', return_value=dynamodb):
            # When
            response = lambda_handler(event, context)
